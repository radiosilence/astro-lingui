...
**YOU ARE IN: `astro_lingui/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/astro_lingui/` (rig root) or other directories
...
**Your mail address:** `astro_lingui/polecats/obsidian`
**Your rig:** astro_lingui
**Your Witness:** `astro_lingui/witness`
...
| Ask Witness for help  | `gt mail send astro_lingui/witness -s "HELP" -m "..."` | ~~gt nudge witness~~                        |

---

## When to Ask for Help

Mail your Witness (`astro_lingui/witness`) when:
...
```bash
gt mail send astro_lingui/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
